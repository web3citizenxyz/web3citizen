  ...
  return (
    <div className={styles.articleContainer}>
      ...
      <section className={styles.section}>
        <h2 className={styles.decentraland}>Decentraland Grants Program</h2>
        <img src="/images/decentraland-grant.svg" alt="Decentraland" className={styles.benefitsImage} /> 
<br></br>
<br></br>
<h1> What is the Decentraland Grants Program?
</h1>

<p>The program is managed by the Decentraland DAO to support projects across seven categories: Core Unit, Platform, Documentation, In-world Content, Social Media Content, Sponsorship, and Accelerator. Since its inception the program has funded over 200 projects in the Decentraland ecosystem.
</p> 
  </section>
<br></br>
...
<ul className={styles.list}>
   ...
   <section className={styles.section}> 
    <h1>Funding</h1>
    <p>Projects of all categories can apply to two tiers of funding:</p>
    <ul className={styles.list}>
      <li><strong>Lower tier:</strong> allows up to $20,000, paid out in stablecoins or MANA using a Vesting Contract as a one-time payment (after 30 days) or with a vesting schedule. </li>
      <li><strong>Higher tier:</strong> allows grants from $20,000 to $240,000, paid out in stablecoins using a Vesting Contract.</li>

    </ul> 
    <p>The DAO community must approve all grant proposal amounts.</p>
</section>
...
<p>Projects are accepted on all stages of development.</p>  
...
<section className={styles.section}> 
<h1>Grant Process</h1>
<img src="/images/decentraland-timelime.svg" alt="Decentraland" className={styles.benefitsImage} />


<p className={styles.subtitle}><strong>Application</strong></p>
      <ul className={styles.list}>
      <p>1. To request a grant from the Decentraland DAO begin by navigating to <a href='https://decentraland.org/governance/submit/grant/' className={styles.a}>decentraland.org/governance/submit/grant/</a> and connect your wallet.</p>
     <p>2. Fill out the Grant Proposal Form including category, desired funding, and general information.<a href='https://docs.decentraland.org/player/general/dao/overview/requesting-grants/' className={styles.a} target='_blank'> Here</a> you can find an overview of the form.</p>
    </ul>
...
<br></br>
  ...
  <li><a className={styles.a} href='https://docs.decentraland.org/player/general/dao/overview/requesting-grants/'>Grant submission form overview</a></li>
