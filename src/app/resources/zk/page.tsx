...
import styles from './zk.module.css';
import Link from 'next/link';

export default function zkHub() {
    ...
    return (
        <div className={styles.zkSection}>
            <div className={styles.headerContainer}>
                <img src="/icons/arrow.svg" alt="Arrow Icon" className={styles.arrow} />
                <h1 className={styles.header}>ZKPs Hub<span className={styles.dot}>.</span></h1>
                <div className={styles.line}></div>
            </div>
            <div className={styles.card}>
                <Link href="/resources/zk/articles/zk-101">
                    <div className={styles.cardHeader}>
                        <img src="/icons/101_logo.png" alt="ZK Logo" className={styles.cardHubIcon} />
                        <h2 className={styles.cardTitle}>ZK 101</h2>
                    </div>
                    <div className={styles.cardLine}></div>
                    <p className={styles.cardDescription}>Learning the essentials for understanding zero-knowledge proofs.</p>
